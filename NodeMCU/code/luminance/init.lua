...
function sayHelloToManager(json)
    ...
    srv:on("receive", function(sck, c) 
        ...
        if recvJson.cmd_ans == true and recvJson.log_ans == true and recvJson.equip == 'luminancev2.0' then
            return true
        else 
...
function buildJSON(ip)
    ...
    msgtable.equip = "luminancev2.0"
    msgtable.imname = "hfv/luminance:v2.0"
