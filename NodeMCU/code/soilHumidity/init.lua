...
function sayHelloToManager(json)
    ...
    srv:on("receive", function(sck, c) 
        ...
        if recvJson.cmd_ans == true and recvJson.log_ans == true and recvJson.equip == 'soilHumidityv2.0' then
            return true
        else 
...
function buildJSON(ip)
    ...
    msgtable.equip = "soilHumidityv2.0"
    msgtable.imname = "hfv/soilhumidity:v2.0"
